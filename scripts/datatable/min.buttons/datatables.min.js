...
oPaginate:{sFirst:"В начало",sLast:"В конец",sNext:"Далее",sPrevious:"Назад"},sEmptyTable:"Нет данных для отображения",sInfo:"Результаты с _START_ по _END_ из _TOTAL_",sInfoEmpty:"",sInfoFiltered:"(Выбрано из _MAX_ результатов)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:'<div class="loader" id="loader" style="margin: 0 auto; border: 5px solid #f3f3f3; border-radius: 50%; border-top: 5px solid #4c1e87; width: 50px; height: 50px; -webkit-animation: spin 1s linear infinite; /* Safari */ animation: spin 1s linear infinite;"></div>',sProcessing:'<div class="loader" id="loader" style="margin: 0 auto; border: 5px solid #f3f3f3; border-radius: 50%; border-top: 5px solid #4c1e87; width: 50px; height: 50px; -webkit-animation: spin 1s linear infinite; /* Safari */ animation: spin 1s linear infinite;"></div>',sSearch:"Найти:",sSearchPlaceholder:"Ключевое слово",sUrl:"",sZeroRecords:"Поиск результатов не дал"},oSearch:h.extend({},
