...
oPaginate:{sFirst:"В начало",sLast:"В конец",sNext:"Далее",sPrevious:"Назад"},sEmptyTable:"Нет данных для отображения",sInfo:"Результаты с _START_ по _END_ из _TOTAL_",sInfoEmpty:"",sInfoFiltered:"(Выбрано из _MAX_ результатов)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Show _MENU_ entries",sLoadingRecords:"Загрузка",sProcessing:"Обработка",sSearch:"Найти:",sSearchPlaceholder:"Ключевое слово",sUrl:"",sZeroRecords:"Поиск результатов не дал"},oSearch:h.extend({},
